  ...
  return (
    <div className = "flex flex-col gap-6">
      <div>
        ...
        <input id="file" name="file" onChange={onChange} type="file" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel,text/csv" />
      </div>
      {file && (
        <section>
